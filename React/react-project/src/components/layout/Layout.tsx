  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="fixed top-4 right-4 z-50 flex items-center gap-2 md:top-6 md:right-6 md:gap-3">
          {/* Notification */}
          <div className="bg-white dark:bg-[#171717] shadow-lg rounded-xl px-2 py-1.5 md:px-2 md:py-1.5 border border-gray-200 dark:border-gray-800">
