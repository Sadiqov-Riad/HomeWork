      ...
      <div className="flex items-center gap-x-5">
        ...
        <div className="relative md:w-65">
          <span className="relative md:absolute inset-y-0 left-0 flex items-center">
            <input type="text" className="w-full bg-white px-4 py-1 pl-4 rounded-tl rounded-bl shadow outline-none hidden md:block"/>
          ...
          >
            <ul className="text-sm text-gray-800 mt-1">
              ...
              <li className="px-4 py-2 hover:bg-gray-100 rounded-bl rounded-br cursor-pointer">
                <a className='' href="#">
                  <MdLogout className='inline-block mr-2 mb-1 w-5 h-5' />
                  Log Out
                  </a>
              </li>
            </ul>
